...
<form class="layui-form layui-row" id="update_goods" action="<?=Url::to(['order/create'])?>">
    ...
    <div class="layui-col-md6 layui-col-xs12" style="padding-top: 15px">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <?= Html::dropDownList('goods_status', null,Order::$goods_status_mapping,
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="goods" lay-verify="required" placeholder="请输入货物" "  class="layui-input">
            </div>
        </div>

    ...
    <div class="layui-col-md6 layui-col-xs12" style="padding-top: 15px">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" lay-verify="required" placeholder="请输入标题" value="<?=$model['name']?>"  class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="desc" lay-verify="required" placeholder="请输入备注" value="<?=$model['desc']?>"  class="layui-input">
            </div>
        </div>

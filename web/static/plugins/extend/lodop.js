...
function getLodop(oOBJECT, oEMBED) {
    ...
    var strCLodopUpdate = "<br><font color='#FF00FF'>Web打印服务CLodop需升级!点击这里<a href='http://www.lodop.net/demolist/CLodop_Setup_for_Win32NT.zip' target='_self'>执行升级</a>,升级后请刷新或重启浏览器。</font>";
    var LODOP;
    try {
        var ua = navigator.userAgent;
        ...
        //LODOP.SET_LICENSES("","7CFD8C999CE5FCA50C460EEEC4341716303","","");
        LODOP.SET_LICENSES("","AE2FBECBCE17D459B1CDA378872E4855617","","");
        //===============================================.com//.com台级//.net
        return LODOP;
    } catch (err) {
